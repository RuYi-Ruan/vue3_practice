  ...
  <el-card class="box-card">
    ...
    >
      ...
      <el-table-column label="品牌操作" align="center">
        <template #="{row, $index}">
          <el-button size="small" type="primary" icon="Edit" @click="$event => updateTrademark(row)">Edit</el-button>
          <el-popconfirm :title="`确认删除${row.tmName}?`" width="250px" icon="QuestionFilled" @confirm="removeTradeMark(row.id)">
            <template #reference>
...
import { Records, TradeMark, TradeMarkResponseData } from '@/api/product/brand/type'
