...
import { MenuParams, Permission, PermissionResponseData } from "./type";
...
// 获取全部菜单与按钮的数据请求
export const reqGetAllMenuData = () => request.get<any, PermissionResponseData>(API.ALLMENUDATA_URL);
